...
Raid2X.downloadConnection = 0;
Raid2X.uploadConnection = 0;
...
Raid2X.prototype.startUpload = function() {
	...
	if(Raid2X.uploadConnection >= maxConnection) { return false; }
...
Raid2X.prototype.startDownload = function() {
	...
	if(Raid2X.downloadConnection >= maxConnection) { return false; }

	var target = this.downloadQueue.pop();
	var path = target.path;

	Raid2X.downloadConnection++;
	var fp = target.path;
